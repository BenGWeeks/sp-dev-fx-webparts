...
export class DataHelperMock implements IDataHelper {
    ...
    groups: [{
      ...
      termSets: [{
        ...
        terms: [{
          ...
          terms: [{
            id: '2494A0ED-0866-4082-92A8-1C83D5B117C4',
            termSetId: 'B12D3D77-7DEA-435E-B1AF-3175DC9851DF',
            name: 'L2 ABC',
            description: 'Term 1 from Term Set 1 from Group 1 from Term Store 1',
            labels: [{
            ...
            terms: [{
              id: '3494A0ED-0866-4082-92A8-1C83D5B117C4',
              termSetId: 'B12D3D77-7DEA-435E-B1AF-3175DC9851DF',
              name: 'L3 DEF',
              description: 'Term 1 from Term Set 1 from Group 1 from Term Store 1',
              labels: [{
              ...
              terms: [{
                id: '4494A0ED-0866-4082-92A8-1C83D5B117C4',
                termSetId: 'B12D3D77-7DEA-435E-B1AF-3175DC9851DF',
                name: 'L4 GHI',
                description: 'Term 1 from Term Set 1 from Group 1 from Term Store 1',
                labels: [{
                ...
                terms: [{
                  id: '5494A0ED-0866-4082-92A8-1C83D5B117C4',
                  termSetId: 'B12D3D77-7DEA-435E-B1AF-3175DC9851DF',
                  name: 'L5 JKL',
                  description: 'Term 1 from Term Set 1 from Group 1 from Term Store 1',
                  labels: [{
  ...
  public getTermStores(): Promise<ITermStore[]> {
    window.console && console.log("DataHelperNock.ts: getTermStores().");
